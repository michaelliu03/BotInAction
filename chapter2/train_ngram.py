...
class TrainNgram():
    ...
    def train(self, train_data_path, wordict_path, transdict_path):
        ...
        for sentence in open(train_data_path,'r',encoding='utf8'):
...
if __name__ == '__main__':
    train_data_path = 'D:\\liuyu\\桌面\\git\\BotInAction\\data\\chapter2\\data\\train.txt'
    wordict_path = 'D:\\liuyu\\桌面\\git\\BotInAction\\data\\chapter2\\model\\word_dict.model'
    transdict_path = 'D:\\liuyu\\桌面\\git\\BotInAction\\data\\chapter2\\model\\trans_dict.model'
    trainer = TrainNgram()
