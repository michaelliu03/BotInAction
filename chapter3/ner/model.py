...
from chapter3.ner.data import pad_sequences,batch_yield
from chapter3.ner.utils import  get_logger
from chapter3.ner.eval import  conlleval
...
class BiLSTM_CRF(object):
    ...
    def biLSTM_layer_op(self):
        ...
        with tf.variable_scope("proj"):
            W = tf.get_variable(name="W",
                                ...
                                initializer=tf.contrib.layers.xaviver_initializer(),
                                dtype=tf.float32)
    ...
    def loss_op(self):
        if self.CRF:
           log_likelihood , self.transition_params = crf_log_likelihood(input =self.logits,
    ...
    def evaluate(self,label_list,seq_len_list,data,epoch=None):
        ...
        for label_,(sent,tag) in zip(label_list,data):
            tag_ = [label2tag[label__] for label__ in label__]
            sent_res = []
