...
class EvalData():
    def __init__(self, config):
        ...
        self._eval_data_path =  os.path.join(base_dir, config["eval_data"])#os.path.join(os.path.abspath(os.path.dirname(os.getcwd())), config["eval_data"])

        self._output_path = os.path.join(out_put_base_dir, config["output_path"])
