...
base_dir="../../data/chapter5/transformer/"
transformer_dir= "../../data/chapter5/transformer/"

#train_dir=os.path.join(base_dir, 'cnews.train.txt')
test_dir=os.path.join(base_dir,'cnews.test.txt')
val_dir=os.path.join(base_dir, 'cnews.val.txt')
vocab_dir=os.path.join(transformer_dir, 'cnews.vocab.txt')

out_put_base_dir = "../../model/chapter5/transformer"

#"ckpt_model_path": "../../model/chapter5/transformer/ckpt_model/",
#"pb_model_path": "../../model/chapter5/transformer/pb_model/"

class TrainData():
    def __init__(self, config):
        #super(TrainData, self).__init__(config)

        self._train_data_path = os.path.join(base_dir, config["train_data"])
        self._output_path = os.path.join(out_put_base_dir,
                                         config["output_path"])
        if not os.path.exists(self._output_path):
            os.makedirs(self._output_path)
        self._word_vectors_path = os.path.join(transformer_dir,
                                               config["word_vectors_path"]) if config["word_vectors_path"] else None
        self._stop_word_path = os.path.join(transformer_dir,
    ...
    def read_data(self):
        ...
        inputs = []
        labels = []
        # with open(self._train_data_path, 'r', encoding='utf-8') as f:
        #     for line in f:
        #         try:
    ...
    def gen_vocab(self, words, labels):
        ...
        with open(os.path.join(self._output_path, "label_to_index.pkl"), "wb") as f:
            pickle.dump(label_to_index, f,0)
